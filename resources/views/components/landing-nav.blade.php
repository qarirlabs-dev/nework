    ...
    <div class="mx-auto">
        <div class="relative flex h-16 items-center justify-between">
                    ...
                    <svg class="block h-8 w-auto lg:hidden" width="200" height="34" viewBox="0 0 200 34"
                        ...
                        <g clip-path="url(#clip0_43_3841)">
                            <path
                                ...
                                fill="#FF9E16" />
                            <path d="M128.304 26.3797H139.263V29.521H124.931V4.53345H128.304V26.3797Z" fill="#00263D" />
                            <path
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="relative">
                            <div class="flex flex-row items-center cursor-pointer" onclick="toggleProgramMenu()">
                                <button
                                    class="text-black  px-3 py-2 font-medium">Programs</button>
                        ...
                        <a href="#"
                            class="text-black  px-3 py-2 font-medium">About</a>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <a href="#"
                    class="text-black  px-3 py-2 font-bold mx-2">Login</a>

                <a href="#"
                    class="text-white px-5 py-2 font-bold rounded-md bg-[#FF9500] mx-2">Join Now</a>
                ...
                <div class="relative mx-2">
                    <div class="flex flex-row items-center" onclick="toggleLanguageMenu()">
                        ...
                        <button
                            class="text-black  px-3 py-2 font-bold">English</button>
                        <svg width="8" height="5" viewBox="0 0 8 5" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M3.30001 4.3L0.700012 1.7C0.383345 1.38333 0.312679 1.021 0.488012 0.613C0.663345 0.205 0.975679 0.000666667 1.42501 0H6.57501C7.02501 0 7.33768 0.204333 7.51301 0.613C7.68835 1.02167 7.61735 1.384 7.30001 1.7L4.70001 4.3C4.60001 4.4 4.49168 4.475 4.37501 4.525C4.25835 4.575 4.13335 4.6 4.00001 4.6C3.86668 4.6 3.74168 4.575 3.62501 4.525C3.50835 4.475 3.40001 4.4 3.30001 4.3Z"
