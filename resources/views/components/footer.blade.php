<footer>
    <div class="relative w-full h-[30rem] bg-[#00263D] flex justify-center">
        ...
        <div class="flex flex-row w-10/12">
            <div class="mt-11 mx-12 w-1/2">
                ...
                <div class="flex flex-row justify-start mt-9">
                    ...
                    <a href="" class="mr-5"><img src="{{Vite::asset('resources/image/icon/tiktok.png')}}" alt="tiktok" class="h-6 object-cover"></a>
                    <a href="" class="mr-5"><img src="{{Vite::asset('resources/image/icon/youtube.png')}}" alt="youtube" class="h-6 object-cover"></a>
            ...
            <div class="flex flex-col">
                <div class="mt-11 flex flex-row mx-12 justify-between">
                    ...
                    <div class="w-1/4 mx-2">
                        ...
                        <p class="text-white font-normal text-base pt-7">CertificatePrivacy & Policy</p>
                    </div>
                    <div class="w-1/4 mx-2">
                        <p class="font-bold text-lg text-[#FF9E16]">About</p>
                        <p class="text-white font-normal text-base pt-12">Career Partnership Pricing</p>
                    </div>
                </div>
