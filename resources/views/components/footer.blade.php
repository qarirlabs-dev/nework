        ...
        <div class="flex flex-col lg:flex-row w-full lg:w-10/12">
            ...
            <div class="flex flex-col">
                ...
                <div class="p-5 lg:p-0 lg:ml-14 mt-24">
                    ...
                    <p class="font-normal text-base text-white mt-2">QarirLabs Office 8, level 18-A, Sudirman Central Business District (SCBD) Jl. Jenderal Sudirman no.1, RT8/RW3, Senayan, Kebayoran Baru, Jakarta Selatan. <br>+62 813 8270 3250 (QarirLabs)</p>
