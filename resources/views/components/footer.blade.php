        ...
        <div class="flex flex-col lg:flex-row w-full lg:w-10/12 absolute top-0">
            ...
            <div class="flex flex-col">
                ...
                <div class="p-5 lg:p-0 lg:ml-14 lg:mt-24">
                    ...
                    <p class="font-normal text-base text-white mt-2">{{config('app.name')}} Office 8, level 18-A, Sudirman Central Business District (SCBD) Jl. Jenderal Sudirman no.1, RT8/RW3, Senayan, Kebayoran Baru, Jakarta Selatan. <br><a href="http://wa.me/6281110014420" target="_blank">+62 811-1001-4420</a> ({{config('app.name')}})</p>
