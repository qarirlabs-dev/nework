        ...
        <div class="flex flex-col lg:flex-row w-full lg:w-10/12 absolute top-0">
            <div class="lg:mt-11 lg:mx-12 p-5 lg:p-0 w-full lg:w-1/2">
                ...
                <div class="flex flex-row justify-start mt-9">
                    <a href="https://www.instagram.com/qarirgenerator/" target="_blank" class="mr-5"><img src="{{Vite::asset('resources/image/icon/instagram.png')}}" alt="instagram" class="h-6 object-cover"></a>
                    <a href="https://www.linkedin.com/company/qarirgen" target="_blank" class="mr-5"><img src="{{Vite::asset('resources/image/icon/linkdin.png')}}" alt="linkdin" class="h-6 object-cover"></a>
                    {{-- <a href="" class="mr-5"><img src="{{Vite::asset('resources/image/icon/twitter.png')}}" alt="twiter" class="h-6 object-cover"></a> --}}
                    <a href="https://youtube.com/@qarirgen" target="_blank" class="mr-5"><img src="{{Vite::asset('resources/image/icon/tiktok.png')}}" alt="tiktok" class="h-6 object-cover"></a>
            ...
            <div class="flex flex-col">
                <div class="p-5 lg:p-0 lg:mt-11 flex lg:flex-row lg:flex-nowrap flex-wrap lg:mx-12 justify-between">
                    <div class="w-full lg:w-1/4 lg:mx-2">
                        ...
                        <p class="text-white font-normal text-base lg:pt-7 pt-2 cursor-pointer" onclick="showModal('digital marketing')">Digital Marketing</p>
                        <p class="text-white font-normal text-base pt-2 cursor-pointer" onclick="showModal('data science')">Data Science</p>
                    </div>
                    <div class="w-full lg:w-1/4 lg:mx-2">
                        <p class="font-bold text-lg text-[#FF9E16] lg:mb-5 mt-5 lg:mt-0">International Bootcamp</p>
                        <p class="text-white font-normal text-base pt-2 lg:pt-0 cursor-pointer" onclick="showModalIndonesia()">Bootcamp Indonesia</p>
                        <p class="text-white font-normal text-base pt-2 cursor-pointer" onclick="showModalIstanbul()">Bootcamp Istanbul</p>
                        <p class="text-white font-normal text-base pt-2 cursor-pointer" onclick="redirectToPage('Tokyo')">Bootcamp Tokyo</p>
                        <p class="text-white font-normal text-base pt-2 cursor-pointer" onclick="redirectToPage('Seoul')">Bootcamp Seoul</p>
                    </div>
                    <div class="w-full lg:w-1/4 lg:mx-2">
                ...
                <div class="p-5 lg:p-0 lg:ml-14 lg:mt-24">
                    ...
                    <p class="font-normal text-base text-white mt-2">{{config('app.name')}} Office 8, level 18-A, Sudirman Central Business District (SCBD) Jl. Jenderal Sudirman no.1, RT8/RW3, Senayan, Kebayoran Baru, Jakarta Selatan. <br><a href="http://wa.me/6281110014450" target="_blank">+62 811-1001-4450</a> ({{config('app.name')}})</p>
