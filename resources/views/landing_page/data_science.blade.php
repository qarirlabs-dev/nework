                ...
                <div class="flex flex-wrap lg:flex-nowrap lg:flex-row justify-between items-center">
                    <div class="lg:hidden flex-auto w-full lg:w-4/12">
                        ...
                        <div class="relative flex lg:h-96 lg:w-96 w-72 h-72">
                            @if (strtolower($slug) != 'indonesia')
                                ...
                                <div class="absolute top-8 left-8 lg:h-96 lg:w-96 w-72 h-72 border-2 border-[#FF9500] rounded-xl">
                                </div>
                            @endif
                    ...
                    <div class="p-6 lg:p-0 flex-auto w-6/12">
                        ...
                        <div class="flex flex-wrap">
                            <button
                                class="text-[#0F5B89] px-4 lg:py-3 py-2 lg:mr-6 mr-2 rounded-full text-sm font-bold mb-4 lg:mb-11 bg-[#DCF2FF]"
                                data-aos="fade-up">Online
                                - Hybrid </button>
                            <button
                                class="text-[#0F5B89] px-4 lg:py-3 py-2 lg:mr-6 mr-2 rounded-full text-sm font-bold mb-4 lg:mb-11 bg-[#DCF2FF]"data-aos="fade-up">Beginner
                                Friendly</button>
                            @if (strtolower($detail) == 'indonesia')
                                <button
                                    class="text-[#0F5B89] px-4 lg:py-3 py-2 lg:mr-6 mr-2 rounded-full text-sm font-bold mb-4 lg:mb-11 bg-[#DCF2FF]"data-aos="fade-up">120
                        ...
                        <div class="flex flex-wrap lg:flex-nowrap lg:flex-row mt-8">
                            <button
                                class="bg-[#0F5B89] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold mb-6 w-full lg:w-auto lg:mb-11"
                                data-aos="fade-up">
                                {{-- {{ strtolower($detail) == 'indonesia' ? 'Pilih Lokasi' : 'Choose Destination' }} --}}
                                Apply Now
                            </button>
                            <button
                                class="lg:ml-4 text-[#0F5B89] px-10 lg:py-4 py-2 rounded-full  text-lg font-bold mb-6 w-full lg:w-auto lg:mb-11 outline outline-1 outline-[#0F5B89]"
        ...
        <div class="hidden lg:block w-4/12 relative">
            <div class="sticky top-10">
                ...
                <div class="flex flex-col w-3/6 mx-auto mt-6">
                    ...
                    <button class="ml-4 mt-8 bg-[#0F5B89] px-9 py-4 rounded-full text-white text-lg font-bold">Let's
                        Get
                        Started</button>
                </div>
            </div>
        ...
        <div class="w-full lg:w-8/12">
                    ...
                    @foreach ($whySouldStay as $item)
                        <div class="bg-white rounded-xl p-6 shadow-sm my-3" data-aos="fade-up">
                            <div class="flex flex-row">
                                ...
                                <p class="ml-6 font-medium text-xl text-[#262626] opacity-80">{!! $item['content'] !!}
                                </p>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="flex flex-row overflow-x-auto lg:flex-wrap mt-8 justify-between" data-aos="fade-up">
                    ...
                    <div class="w-full lg:w-1/3 mb-8">
                        <div
                            ...
                            <p class="text-center font-bold text-xl text-[#262626] opacity-80 mt-6">Equipped by
            ...
            <section class="curriculum w-full lg:w-11/12 mt-12" id="learcnphase">
                ...
                <div class="flex justify-center mt-4" data-aos="fade-up">
                    <button class="bg-[#0F5B89] px-6 py-3 font-bold text-lg rounded-full text-white">Download
                        Syllabus</button>
                </div>
            </section>
                        ...
                        @foreach ($programFee as $item)
                            <div class="lg:w-1/2 w-full py-0 px-3">
                                <div class="bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="px-4 pt-4">
                                        <p class="font-normal text-sm text-[#262626]">Price From</p>
                                        <p class="font-black text-xl text-[#262626] mt-1">{{ $item['price'] }}</p>
                                    </div>
            ...
            <section class="w-11/12 mt-12 mx-auto" id="studylocation">
                ...
                <div class="flex lg:flex-row flex-col mt-10" data-aos="fade-up" id="study-change-location">
                    <a href="{{ route('detail', ['slug' => 'indonesia', 'course' => $course]) }}"
                        ...
                        <div class="relative bg-white rounded-lg shadow-sm w-full">
                            ...
                            <p class="font-bold text-xl px-4 py-5 text-center">Bahasa Indonesia</p>
                        </div>
                    </a>
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-12 flex w-full text-center">
                                            <a href="https://drive.google.com/file/d/10p1af15lw6lbzdG4Ayyqpjei0bV6g2YW/view"
                                                target="_blank"
                                                class="w-full text-[#0F5B89] px-10 py-2 rounded-full text-lg font-bold mb-3 outline outline-1 outline-[#0F5B89]">See
                                                Portofolio</a>
                                        </div>
                                    </div>
                                </div>
            ...
            @if (strtolower($slug) == 'indonesia')
                <section class="portofolio w-full lg:w-11/12 mt-12" id="portofolio" data-aos="fade-up">
                    <div class="relative full-width flex">
                        <div class="w-full h-72">
                            <img src="{{ Vite::asset('resources/image/ilustration/meet_our_career.png') }}"
                                alt="meet career" class="rounded-2xl object-cover h-72 hidden lg:block">
                        </div>
                        <div class="absolute top-5 lg:mx-0 lg:top-10 lg:left-10 bg-white rounded-2xl w-full lg:w-5/12 p-6 shadow-sm lg:shadow-none">
                            <p class="font-black text-2xl text-[#262626] lg:w-4/5 w-full">Meet Our Career Manager In Indonesia
                            </p>
                            <div class="flex w-full lg:w-3/5 mt-4">
                    ...
                    <div class="w-full lg:w-1/2 lg:mr-16" data-aos="fade-up">
                        ...
                        <div class="flex w-full lg:w-auto">
                            <a href="https://y-data.typeform.com/to/U4W5pFEE/?form_position=%2F&gaid=1160409597.1681175250&referrer=N%2FA&_ga=2.178558691.63757594.1681175250-1160409597.1681175250&typeform-source=practicum.com"
                                target="_blank"
                                class=" bg-[#0F5B89] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold mb-11 mt-6 w-full lg:w-auto text-center">Take
                                a
                                Career Quiz</a>
                        </div>
                    </div>
                ...
                <div class="relative flex justify-end rounded-xl">
                    ...
                    <div class="absolute top-0 left-0 h-80 w-full flex justify-start items-center ">
                        <div class="flex flex-col lg:ml-28 p-10 lg:p-0">
                            ...
                            <div>
                                <button
                                    class="bg-[#0F5B89] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold mb-11 mt-10">Let's
                                    Get Started</button>
                            </div>
                        </div>
                    </div>
