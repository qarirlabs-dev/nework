    ...
    <div class="flex flex-row my-10 lg:p-0 p-6" data-aos="fade-up">
        <div class="hidden lg:block w-4/12 relative">
            <div class="sticky top-10">
                ...
                <div class="flex flex-col w-3/6 mx-auto mt-6">
                    ...
                    <button class="ml-4 mt-8 bg-[{{$themeColor}}] px-9 py-4 rounded-full text-white text-lg font-bold">Mari Kita Mulai</button>
                </div>
            </div>
        </div>
        <div class="w-full lg:w-8/12">
            ...
            <section class="curriculum w-full lg:w-11/12 mt-12" id="learcnphase">
                ...
                <p class="font-normal text-sm lg:text-base text-[#262626]" data-aos="fade-up">Setiap mata pelajaran akan
                    mengharuskan Anda untuk menerapkan apa yang Anda pelajari
                    dengan pengalaman langsung melalui tugas praktis dan umpan balik langsung dari instruktur Anda. Di dalam
                        ...
                        <div class="flex flex-col items-center justify-center gap-3">
                            <div class="w-96 p-3">
                                <div class="bg-white rounded-lg p-8 shadow-sm h-96">
                                    ...
                                    <p class="font-medium text-base text-[#262626] mt-5">"Di sini, saya tidak hanya dapat mengikuti kelas-kelas yang menyenangkan, tetapi juga menambah jaringan dan pengetahuan saya karena pelatih yang sangat berpengalaman." Hieronymus </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col items-center justify-center gap-3">
                            <div class="w-96 p-3">
                                <div class="bg-white rounded-lg p-8 shadow-sm h-96">
                                    ...
                                    <p class="font-medium text-base text-[#262626] mt-5"> "Wujudkan impian saya untuk bekerja sebagai performance specialist dengan mulai belajar Digital Marketing Bootcamp!”"-Tyas</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col items-center justify-center gap-3">
                            ...
                            <div class="w-96 p-3">
                                <div class="bg-white rounded-lg p-8 shadow-sm h-96">
                                    ...
                                    <p class="font-medium text-base text-[#262626] mt-5">"Materi pembelajarannya sangat lengkap, kelasnya terstruktur dengan baik, dan layanan konsultasinya memuaskan." - Angeline Lie</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="portofolio w-full lg:w-11/12 mt-12" id="portofolio" data-aos="fade-up">
                <div class="w-full h-72 flex rounded-xl p-4 lg:p-10" style="background-image: url('{{ Vite::asset('resources/image/ilustration/meet_our_career.png') }}'); border-radius: 16px; background-size: cover; ">
                    <a href="https://www.linkedin.com/in/nailawaliyahamima/" target="_blank"
                        ...
                        <p class="font-black text-2xl text-[#262626] w-full lg:w-10/12">Temui Career Manager Kami Di Indonesia</p>
                    ...
                    <div class="w-full lg:w-1/2 lg:mr-16 mt-12 lg:mt-0" data-aos="fade-up">
                        ...
                        <div class="flex w-full lg:w-auto">
                            <a href="https://y-data.typeform.com/to/U4W5pFEE/?form_position=%2F&gaid=1160409597.1681175250&referrer=N%2FA&_ga=2.178558691.63757594.1681175250-1160409597.1681175250&typeform-source=practicum.com"
                                target="_blank"
                                class=" bg-[{{$themeColor}}] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold mb-11 mt-6 w-full lg:w-auto text-center">Ikuti Kuis Karir</a>
                        </div>
                    </div>
                ...
                <div class="relative flex justify-end rounded-xl">
                    ...
                    <div class="absolute top-0 left-0 h-80 w-full flex justify-start items-center ">
                        <div class="flex flex-col lg:ml-28 p-10 lg:p-0">
                            ...
                            <div>
                                <button
                                    class="bg-[{{$themeColor}}] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold mb-11 mt-10">Mari Kita Mulai</button>
                            </div>
                        </div>
                    </div>
                </div>
