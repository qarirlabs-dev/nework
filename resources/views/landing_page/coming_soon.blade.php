        ...
        <div class="alternative w-full h-auto">
            ...
            <div class="absolute top-1/3 w-full z-10">
                <div class="flex flex-col justify-center items-center">
                    <p class="font-black text-2xl lg:text-4xl text-[#262626]  mb-4 text-center">We will landing soon in {{ ucwords($slug)}}</p>
            ...
            <lottie-player src="{{asset('img/plane_animation.json')}}" background="transparent"  speed="1"  loop autoplay class="w-full h-full absolute top-12"></lottie-player>
        </div>
    </div>
</x-landing-layout>
