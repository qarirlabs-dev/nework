                ...
                <div class="flex flex-wrap lg:flex-nowrap lg:flex-row justify-between items-center">
                    <div class="lg:hidden flex-auto w-full lg:w-4/12">
                        ...
                        <div class="relative flex lg:h-96 lg:w-96 w-72 h-72 mb-10 lg:mb-0">
                            @if (strtolower($slug) != 'indonesia')
                                <div class="absolute top-0 left-5 lg:top-0 lg:left-5 lg:h-96 lg:w-96 w-72 h-72 border-2 border-[#FF9500] rounded-xl">
                                </div>
                                <div class="absolute top-10 left-10 lg:top-8 lg:left-8 lg:h-96 lg:w-96 w-72 h-72 border-2 border-[#FF9500] rounded-xl">
                                </div>
                            @endif
                    ...
                    <div class="p-6 lg:p-0 flex-auto w-full lg:w-6/12">
                        ...
                        <div class="flex flex-wrap">
                            <button
                                class="text-[#FF7A00] px-4 py-3 lg:mr-6 mr-2 rounded-full text-sm font-bold mb-4 lg:mb-11 bg-[#FFE6CE]"
                                data-aos="fade-up">Online - Hybrid
                            </button>
                            <button
                                class="text-[#FF7A00] px-4 py-3 lg:mr-6 mr-2 rounded-full text-sm font-bold mb-4 lg:mb-11 bg-[#FFE6CE]"data-aos="fade-up">Beginner
                                Friendly</button>
                            <button
                                class="text-[#FF7A00] px-4 py-3 lg:mr-6 mr-2 rounded-full text-sm font-bold mb-4 lg:mb-11 bg-[#FFE6CE]"data-aos="fade-up">35
                                limited seat</button>
                        </div>
                        ...
                        <div class="flex flex-wrap lg:flex-nowrap lg:flex-row mt-8">
                            <button
                                class="bg-[#FF9500] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold lg:mb-11 mb-5 w-full lg:w-auto"
                                data-aos="fade-up">Choose
                                Destination</button>
                            <button
                                class="lg:ml-4 text-[#FF9500] px-10 lg:py-4 py-2 rounded-full  text-lg font-bold mb-11 w-full lg:w-auto outline outline-1 outline-[#FF9500]"
        ...
        <div class="hidden lg:block w-4/12 relative">
            <div class="sticky top-10">
                ...
                <div class="flex flex-col w-3/6 mx-auto mt-6">
                    ...
                    <button class="ml-4 mt-8 bg-[#FF9500] px-9 py-4 rounded-full text-white text-lg font-bold">Let's Get
                        Started</button>
                </div>
            </div>
        </div>
        <div class="w-full lg:w-8/12">
            ...
            <section class="p-6 lg:p-0 curriculum w-full lg:w-11/12 mt-12">
                ...
                <div class="flex justify-center mt-4" data-aos="fade-up">
                    <button class="bg-[#FF9500] px-6 py-3 font-bold text-lg rounded-full text-white">Download
                        Syllabus</button>
                </div>
            </section>
                ...
                <section class="p-6 lg:p-0 w-full lg:w-11/12 mt-12" id="destination">
                    ...
                    <div class="flex justify-between lg:flex-row flex-col mt-10" data-aos="fade-up"
                        ...
                        @foreach ($destinations as $item)
                            <div class="lg:w-1/3 w-full py-0 px-3 mb-5">
            ...
            @if (count($programFee) > 0)
                <section class="w-11/12 mt-12 mx-auto" id="programFee">
                    ...
                    <div class="flex justify-between lg:flex-row flex-col mt-10" data-aos="fade-up"
                        ...
                        @foreach ($programFee as $item)
                            <div class="lg:w-1/2 w-full py-0 px-3 mb-5">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-12 flex w-full text-center">
                                            <a href="https://drive.google.com/file/d/1JsVLjjQFgtefF0X7P9OGviKCWAxPwioV/view?usp=sharing"
                                                target="_blank"
                                                class="w-full text-[#FF9500] px-10 lg:py-4 py-2 rounded-full text-lg font-bold mb-3 outline outline-1 outline-[#FF9500]">See
                                                Portofolio</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="p-6 lg:p-0 w-full lg:w-11/12 mt-12" id="admissions">
                <div class="flex flex-wrap lg:flex-nowrap lg:flex-row justify-center items-center">
                    ...
                    <div class="w-full lg:w-1/2 lg:mr-16" data-aos="fade-up">
                        ...
                        <button
                            class="bg-[#FF9500] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold mb-11 mt-6 w-full lg:w-auto text-center">Take
                ...
                <div class="relative flex justify-end rounded-xl">
                    ...
                    <div class="absolute top-0 left-0 h-80 w-full flex justify-start items-center ">
                        <div class="flex flex-col lg:ml-28 p-10 lg:p-0">
                            ...
                            <div>
                                <button
                                    class="bg-[#FF9500] px-10 lg:py-4 py-2 rounded-full text-white text-lg font-bold mb-11 mt-10">Let's
                                    Get Started</button>
                            </div>
                        </div>
                    </div>
