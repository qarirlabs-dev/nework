                        ...
                        <div class="flex flex-col items-center justify-center gap-3">
                            <div class="w-80 p-3">
                                <div class="bg-white rounded-lg p-2 shadow-sm">
                                    ...
                                    <div class="p-4">
                                        <p class="font-bold text-2xl text-[#262626] mb-4">Disney+ Hotstar Strategi Campaign</p>
                                        ...
                                        <div class="mt-12 flex w-full text-center">
                                            <a href="https://drive.google.com/file/d/1JsVLjjQFgtefF0X7P9OGviKCWAxPwioV/view?usp=sharing" target="_blank"
                            ...
                            <div class="w-80 p-3">
                                <div class="bg-white rounded-lg p-2 shadow-sm">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-12 flex w-full text-center">
                                            <a href="https://drive.google.com/file/d/1aUGT3GxkIWt3eUWoKJ5z6QvOmKcsEIPc/view?usp=sharing" target="_blank"
                                            class="w-full text-[#0F5B89] px-10 py-2 rounded-md text-lg font-bold mb-3 outline outline-1 outline-[#0F5B89]">See
                                            Portofolio</a>
                                        </div>
                                    </div>
                            ...
                            <div class="w-80 p-3">
                                <div class="bg-white rounded-lg p-2 shadow-sm">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-12 flex w-full text-center">
                                            <a href="https://drive.google.com/file/d/1IdPOKd5v84YGDvhfNMmlFunG8k1AousD/view?usp=sharing " target="_blank"
                                            class="w-full text-[#0F5B89] px-10 py-2 rounded-md text-lg font-bold mb-3 outline outline-1 outline-[#0F5B89]">See
                                            Portofolio</a>
                                        </div>
                                    </div>
